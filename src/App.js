...
function App() {
  ...
  return (
    <>
      ...
      <Route exact path="/bench-list" component={BenchList} />
      ...
      <Route
        ...
        component={AdminTaskExtensionRequestList}
      />
      <Route
        exact
        path="/employee-request-add"
        component={EmployeeTimeExtensionRequestAdd}
      />
      <Route
        exact
        path="/employee-status-checklist"
        component={EmployeeStatusCheckList}
      />
      <Route
        exact
        path="/employee-status-checkform"
        component={EmployeeTimeExtensionStatusCheck}
      />
      <Route
        exact
        path="/employee-task-assign-checkform"
        component={EmployeeTaskAssignCheckForm}
      />
    </>
  );
}
