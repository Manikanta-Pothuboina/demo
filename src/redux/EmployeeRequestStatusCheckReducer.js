...
const EMPLOYEE_GET_ALL_REQUESTS_BY_TASK_ID_ACTION_TYPE =
  "EMPLOYEE_GET_ALL_REQUESTS_BY_TASK_ID_ACTION_TYP";
...
export const getAllEmployeeRequestsCheckAction = (payload) => {
  return async (dispatch) => {
    ...
    // UI UPDATE
    dispatch({
      type: EMPLOYEE_GET_ALL_REQUESTS_BY_TASK_ID_ACTION_TYPE,
